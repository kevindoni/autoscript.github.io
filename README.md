...
## ⏩ Installation ⏪
> rm -f setup.sh && apt-get update -y && apt-get upgrade -y && apt install screen zip ftp bzip2 gzip coreutils wget curl neofetch -y && wget -O setup.sh https://raw.githubusercontent.com/kevindoni/autoscript.github.io/main/setup.sh && chmod +x setup.sh && screen -S setup ./setup.sh
